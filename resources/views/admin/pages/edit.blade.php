...
@endsection
@section('main')
    {!! Form::open(['method' => 'PATCH', 'route' => ['admin.pages.update',$page->id]]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('og_image', $page->og_image, ['class' => 'form-control','placeholder' => 'https://']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('cannonical', 'Cannonical URL', ['class' => 'col-form-label']) !!}
                            {!! Form::text('cannonical', $page->cannonical, ['class' => 'form-control','placeholder' => 'https://']) !!}
                        </div>
                        <div class="form-group">
